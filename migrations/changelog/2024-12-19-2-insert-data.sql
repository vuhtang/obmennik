insert into customer (id, name, surname, email, password, dob)
values (1, 'Vladimir', 'Karasev', 'volodya35@mail.ru', 'qwerty', date '1983-08-26'),
       (2, 'Stepan', 'Kuznetcov', 'stepka334@yandex.ru', '12345', date '1999-12-12'),
       (3, 'Maria', 'Databasova', 'lublypostgres@gmail.com', '12345', date '1998-03-05'),
       (4, 'Danil', 'Kologriviy', 'esenin@mail.ru', '12345', date '2003-11-12'); -- работник поддержки
